  ...
  return (
    <section className="w-full bg-white py-20 lg:py-28">
      <div className="mx-auto max-w-3xl px-6 sm:px-10 lg:px-8">
        <div className="mb-6 h-px w-12 bg-[#0b1220]/35" aria-hidden="true" />
        ...
        <div className="mt-8 space-y-6 text-base leading-relaxed text-stone-600 sm:text-lg">
          ...
          <p>
            ...
            major transformation portfolios and led global product organisations
            responsible for platforms supporting more than 80 CCPs and
            exchanges.
          </p>
          ...
          <p>
            ...
            portfolios and generated annual recurring revenue through commercial
            product development.
          </p>
