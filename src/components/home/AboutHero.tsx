export function AboutHero() {
  return (
    <section className="relative isolate w-full overflow-hidden bg-white">
      {/* Narrower tinted panel, pushed further right */}
      <div
        aria-hidden
      ...
      {/* Same horizontal inset as AboutStory so copy lines up */}
      ...
      {/* Mark shifted right with the tint panel; text→icon gap preserved */}
      <div
