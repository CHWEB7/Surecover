    ...
    <div className="relative z-10 flex h-full w-full flex-col justify-between p-8 sm:p-10">
      ...
      <div className="relative mx-auto aspect-square w-full max-w-[17rem]">
        ...
        >
          ...
          {[
            { x: 36, y: 42, label: "Membership" },
            { x: 164, y: 48, label: "Products" },
            { x: 168, y: 148, label: "Positioning" },
            { x: 32, y: 152, label: "Access" },
          ].map((node) => (
            <g key={node.label}>
              <line
                x1="100"
        ...
        <div className="pointer-events-none absolute inset-0">
          <span className="absolute top-[12%] left-[2%] text-[10px] font-semibold tracking-wide text-white/90 uppercase">
            Membership
          </span>
          <span className="absolute top-[14%] right-[0%] text-[10px] font-semibold tracking-wide text-white/90 uppercase">
            Products
          </span>
          <span className="absolute right-[0%] bottom-[18%] text-[10px] font-semibold tracking-wide text-white/90 uppercase">
            Positioning
          </span>
          <span className="absolute bottom-[16%] left-[4%] text-[10px] font-semibold tracking-wide text-white/90 uppercase">
            Access
          </span>
        </div>
      </div>
